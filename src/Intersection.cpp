...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    // Blocking wait until the light is green
    if(m_trafficLight.getCurrentPhase() == TrafficLightPhase::red)
    {
        m_trafficLight.waitForGreen();
    }
    lck.unlock();
}
...
bool Intersection::trafficLightIsGreen()
{
   ...
   if (m_trafficLight.getCurrentPhase() == TrafficLightPhase::green)
        return true;
    else
        return false;
